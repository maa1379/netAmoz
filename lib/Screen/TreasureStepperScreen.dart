...
class TreasureStepperScreen extends StatefulWidget {
  @override
  _TreasureStepperScreenState createState() =>
      _TreasureStepperScreenState();
}

class _TreasureStepperScreenState extends State<TreasureStepperScreen> {
  Size size;
  String value = "";
