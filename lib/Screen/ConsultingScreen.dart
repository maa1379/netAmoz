...
class _ConsultingScreenState extends State<ConsultingScreen> {
  Size size;
  DetailConsultingController ticketController = Get.put(DetailConsultingController());
              ...
              (item.file == null || item.file == "")
                  ...
                  : Container(
                      ...
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.end,
                        children: [
                          Image.network("http://87.107.172.122" + item.file),
                          SizedBox(
                            height: size.height * .02,
                          ),
                          Row(
              ...
              prefixIcon: GestureDetector(
                onTap: () {
                  if (ticketController.textController.isBlank ||
                    ...
                    ticketController.TicketList.add(AnswerList(
